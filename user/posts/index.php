        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `application_list` where member_id = '{$_settings->userdata('id')}' order by unix_timestamp(`date_created`) desc ");
						...
						<tr>
							...
							<td class="">
								<div style="line-height:1em">
									...
									<div><span class="text-muted mr-1">Destination:</span><?= $row['destination'] ?></div>
								</div>	
							</td>
							<td class="text-center">
								...
								switch($row['status']){
									case 0:
										...
										break;
									case 1:
										echo '<span class="badge badge-primary bg-gradient-primary text-sm px-3 rounded-pill">Approved</span>';
										break;
									case 2:
							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <a class="dropdown-item edit_data" href="./?page=applications/manage_application&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
				                    <div class="dropdown-divider"></div>
