				...
				<div class="card shadow" style="border-radius: 15px;">
					<div class="card-body">
						<div class="container-fluid">
							...
							<div class="container-fluid bg-gradient-dark" style="height: 30em !important; border-radius: 15px;">
								<?php
											...
											<div class="carousel-inner h-100">
												<?php foreach ($files as $k => $img) : ?>
													<div class="carousel-item  h-100 <?php echo $k == 0 ? 'active' : '' ?>">
														<img class="d-block w-100  h-100" style="object-fit:scale-down; border-radius: 15px;" src="<?php echo $img ?>" alt="">
													</div>
												<?php endforeach; ?>
											</div>
